...
class SearchVC: UIViewController {
    ...
    func configureLogoImageView() {
        ...
        let topConstraintConstant: CGFloat = DeviceTypes.isiPhoneSE ||
                                             DeviceTypes.isiPhone8Zoomed ? 20 : 80
    ...
    func configureCallToActionButton() {
        ...
        NSLayoutConstraint.activate([
            callToActionButton.bottomAnchor.constraint(equalTo:
                view.safeAreaLayoutGuide.bottomAnchor, constant: -50),
